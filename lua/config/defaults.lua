...
M.highlights = {
    ...
    ChatGPTQuestion = { fg = M.colors.blue.base, italic = true, bold = false },
    ChatGPTWelcome = { fg = M.colors.blue.base, italic = true, bold = false },
    ChatGPTTotalTokens = { fg = M.colors.white.base, bg = M.colors.gray.base },
    ChatGPTTotalTokensBorder = { fg = M.colors.gray.base },
    ChatGPTMessageAction = { fg = M.colors.white.base, bg = M.colors.gray.base, italic = true },
    ChatGPTCompletion = { fg = M.colors.blue.base, italic = true, bold = false },
